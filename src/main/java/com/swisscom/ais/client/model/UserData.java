...
public class UserData extends AbstractUserData {
    ...
    public void setFromPropertiesClasspathFile(String fileName) {
        ...
        try {
            ...
            throw new RestClientException("Failed to load user data properties from classpath file: [" + fileName + "]", exception);
        }
    ...
    public void setFromPropertiesFile(String fileName) {
        ...
        try {
            ...
            throw new RestClientException("Failed to load user data properties from file: [" + fileName + "]", exception);
        }
        setFromProperties(properties);
    }
    ...
    public void validateYourself(SignatureMode signatureMode, Trace trace) {
        if (transactionId == null || transactionId.trim().isEmpty()) {
            throw new RestClientException("The user data's transactionId cannot be null or empty. For example, you can set it to a new UUID "
